...
const ANTHROPIC = {
  ...
  async answerSearch({ q, lens, loc }) {
    ...
    const data = await ANTHROPIC.call({
      model: process.env.ANTHROPIC_SEARCH_MODEL || 'claude-sonnet-4-5',
...
const PROVIDERS = { gemini: GEMINI, anthropic: ANTHROPIC, deepseek: DEEPSEEK, openai: OPENAI };
const KEY_ENV = { gemini: 'GEMINI_API_KEY', anthropic: 'ANTHROPIC_API_KEY', deepseek: 'DEEPSEEK_API_KEY', openai: 'OPENAI_API_KEY' };
